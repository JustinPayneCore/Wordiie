    ...
    public class WordieGame
    {
        ...
        public void SetupGame()
        {
            ...
            for (int i = 0; i < wordsToGuess; i++)
            {
                ...
                string randomAnswer = (string)possible_answers[randomIndex];
                answers.Add(randomAnswer);
                Console.WriteLine("Generated word " +  i + ": " + randomAnswer);
            }
        ...
        public void makeGuess(string input)
        {
            ...
            if (validGuess) {
                // empty results
                results = new List<String>(wordsToGuess);

                for (int count = 0; count < wordsToGuess; count++)
                {
                    result = "";
                    for (int i = 0; i < input.Length; i++)
                    {
                        result += compareGuessLetterByLetter(input.Substring(i, 1), i, count);
                    }
                    ...
                    if (results[count] == "ccccc")
                    {
                        isCorrects[count] = true;
                    }
                }
        ...
        {
            if (letter == answers[wordNum].Substring(index, 1))
            {
            ...
            if (answers[wordNum].Contains(letter))
            {
